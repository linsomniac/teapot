...
// Held fire emits on every third simulation tick: immediate on press, then
// two intervening ticks between shots (50 ms at the fixed 60 Hz rate).
export const PLAYER_FIRE_INTERVAL_TICKS = 3;
